...
\begin{table}[!ht]
\centering
\caption{Folded proportion and experimental stability of the 5 sequences for fine-tuning}
\label{tab:protein_summary}
\begin{tabular}{clcccc}
\toprule
Sequence ID & PDB name & $p_{\text{folded}}$ & $\Delta G_{\text{exp}}$ (kcal/mol) & CI$_{95,\text{low}}$ & CI$_{95,\text{high}}$ \\
\midrule
